...
import hamimg from "../../assets/Icon/hamburger.png";
import deliveryimg from "../../assets/Icon/delivery-man.png";
import topimg from "../../assets/Icon/top-food.png";
import "./HeroTwoSection.module.css";
        ...
        <Row className={classes.row_cards}>
            ...
            <div className={`${classes.card_one} ${classes.card}`}>
              <div className={classes.card_content}>
                <div className={classes.card_image_div}>
                  <img className="img" src={hamimg} alt="Hanmburger"></img>
                </div>
            ...
            <div className={`${classes.card_two} ${classes.card}`}>
              <div className={classes.card_content}>
                <div className="card_image_div">
                  <img className="img" src={deliveryimg} alt="Delivery man"></img>
                </div>
                <div className={classes.card_text_div}>
                  <h5>fast delivery</h5>
                  <p>
          ...
          >
            <div className={`${classes.card_three} ${classes.card}`}>
              <div className={classes.card_content}>
                <div className={classes.card_image_div}>
                  <img className="img" src={topimg} alt="Thumbs up"></img>
                </div>
                <div className={classes.card_text_div}>
                  <h5>100% quality</h5>
                  <p>
